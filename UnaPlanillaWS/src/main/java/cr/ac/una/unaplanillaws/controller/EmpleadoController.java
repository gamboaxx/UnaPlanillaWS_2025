...
public class EmpleadoController {
    ...
    public Response validarUsuario (@Parameter(description = "Codigo de usuario")@PathParam("usuario") String usuario,@Parameter(description = "Clave de usuario") @PathParam("clave") String clave){
        try{
    ...
    @GET
    @Path("/empleados/{nombre}/{pApellido}/{cedula}/{sApellido}")
    @Produces(MediaType.APPLICATION_JSON)
    @Consumes(MediaType.APPLICATION_JSON)
    public Response getEmpleados (@PathParam("cedula") String cedula,@PathParam("nombre") String nombre
            ,@PathParam("pApellido") String pApellido,@PathParam("sApellido") String sApellido){
        try{
